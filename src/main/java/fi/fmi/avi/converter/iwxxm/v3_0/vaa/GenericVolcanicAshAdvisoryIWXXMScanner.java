package fi.fmi.avi.converter.iwxxm.v3_0.vaa;
...
public class GenericVolcanicAshAdvisoryIWXXMScanner extends AbstractIWXXM30GenericAviationWeatherMessageScanner {
    ...
    static {
        ...
        locationIndicatorExpressions.put(GenericAviationWeatherMessage.LocationIndicatorType.ISSUING_CENTRE,
                "iwxxm30:issuingVolcanicAshAdvisoryCentre/aixm:Unit/aixm:timeSlice/aixm:UnitTimeSlice");
