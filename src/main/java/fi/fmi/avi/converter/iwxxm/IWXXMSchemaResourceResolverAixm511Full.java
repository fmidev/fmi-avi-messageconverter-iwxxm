 ...
 */
public class IWXXMSchemaResourceResolverAixm511Full extends IWXXMSchemaResourceResolver {

    private static final ConcurrentMap<String, LSInput> cache = new ConcurrentHashMap<>();
    private static IWXXMSchemaResourceResolverAixm511Full instance;

    private IWXXMSchemaResourceResolverAixm511Full() {
    }

    public synchronized static IWXXMSchemaResourceResolverAixm511Full getInstance() {
        if (instance == null) {
            instance = new IWXXMSchemaResourceResolverAixm511Full();
        }
        return instance;
    }
    ...
    public EnumSet<NamespaceLocation> ignoredNamespaceLocations() {
        return EnumSet.of(NamespaceLocation.AIXM511WX);
    }
