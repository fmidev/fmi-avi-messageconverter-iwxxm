package fi.fmi.avi.converter.iwxxm.v3_0.tca;
...
public class GenericTropicalCycloneAdvisoryIWXXMScanner extends AbstractIWXXM30GenericAviationWeatherMessageScanner {
    ...
    static {
        ...
        locationIndicatorExpressions.put(GenericAviationWeatherMessage.LocationIndicatorType.ISSUING_CENTRE,
                "iwxxm30:issuingTropicalCycloneAdvisoryCentre/aixm:Unit/aixm:timeSlice/aixm:UnitTimeSlice");
