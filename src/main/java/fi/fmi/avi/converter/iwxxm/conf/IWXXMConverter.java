...
public class IWXXMConverter {
    ...
    /**
     * Pre-configured spec for {@link TAF} to IWXXM 2.1 XML format TAF document AsString.
     */
    ...
    /**
     * Pre-configured spec for {@link TAF} to IWXXM 2.1 XML format TAF document AsDOM Node.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format TAF document AsString to {@link TAF}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format TAF document AsDOM Node to {@link TAF}.
     */
    ...
    /**
     * Pre-configured spec for {@link TAFBulletin} to WMO COLLECT 1.2 XML AsString containing IWXXM 2.1 TAFs.
     */
    ...
    /**
     * Pre-configured spec for {@link TAFBulletin} to WMO COLLECT 1.2 XML AsDOM document containing IWXXM 2.1 TAFs.
     */
    ...
    /**
     * Pre-configured spec for WMO COLLECT 1.2 XML AsString containing IWXXM 2.1 TAFs to {@link TAFBulletin}.
     */
    ...
    /**
     * Pre-configured spec for WMO COLLECT 1.2 XML AsDOM document containing IWXXM 2.1 TAFs to {@link TAFBulletin}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format METAR document AsString to {@link METAR}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format METAR document AsDOM Node to {@link METAR}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format SPECI document AsString to {@link SPECI}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format SPECI document AsDOM Node to {@link SPECI}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format SIGMET document AsString to {@link SIGMET}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 2.1 XML format SIGMET document AsDOM Node to {@link SIGMET}.
     */
    ...
    /**
     * Pre-configured spec for {@link SIGMET} to IWXXM 2.1 XML format SIGMET document AsString.
     */
    ...
    /**
     * Pre-configured spec for {@link SIGMET} to IWXXM 2.1 XML format SIGMET document AsDOM Node.
     */
    ...
    /**
     * Pre-configured spec for {@link AIRMET} to IWXXM 2.1 XML format AIRMET document AsString.
     */
    ...
    /**
     * Pre-configured spec for {@link AIRMET} to IWXXM 2.1 XML format AIRMET document AsDOM Node.
     */
    ...
    // *******************
    /**
     * Pre-configured spec for IWXXM 3.0 XML format Space Weather Advisory document AsString to {@link SpaceWeatherAdvisory}.
     */
    ...
    /**
     * Pre-configured spec for IWXXM 3.0 XML format Space Weather Advisory document AsDOM node to {@link SpaceWeatherAdvisory}.
     */
    ...
    /**
     * Pre-configured spec for {@link SpaceWeatherAdvisory} to IWXXM 3.0 XML format SWX document AsString.
     */
    ...
    /**
     * Pre-configured spec for {@link SpaceWeatherAdvisory} to IWXXM 3.0 XML format SWX document AsDOM node.
     */
    ...
    /**
     * Pre-configured spec for {@link SpaceWeatherBulletin} to WMO COLLECT 1.2 XML AsString containing IWXXM 3.0 SpaceWeatherAdvisories.
     */
    ...
    /**
     * Pre-configured spec for {@link SpaceWeatherBulletin} to WMO COLLECT 1.2 XML AsDOM document containing IWXXM 3.0 SpaceWeatherAdvisories.
     */
    ...
    /**
     * Pre-configured spec for WMO COLLECT 1.2 XML AsString containing IWXXM 3.0 SpaceWeatherAdvisories to {@link SpaceWeatherBulletin}.
     */
    ...
    /**
     * Pre-configured spec for WMO COLLECT 1.2 XML AsDOM document containing IWXXM 3.0 SpaceWeatherAdvisories to {@link SpaceWeatherBulletin}.
     */
    ...
    /**
     * Pre-configured spec for WMO COLLECT 1.2 XML AsDOM document to {@link GenericMeteorologicalBulletin}
     */
    ...
    /**
     * Pre-configured spec for WMO COLLECT 1.2 XML document AsString to {@link GenericMeteorologicalBulletin}
     */
