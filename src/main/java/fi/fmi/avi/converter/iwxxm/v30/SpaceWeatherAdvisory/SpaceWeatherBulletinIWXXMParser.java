...
public abstract class SpaceWeatherBulletinIWXXMParser<T> extends AbstractBulletinIWXXMParser<T, SpaceWeatherAdvisory, SpaceWeatherBulletin> {
    ...
    public static class DOM extends SpaceWeatherBulletinIWXXMParser<Document> {
        @Override
    ...
    public static class String extends SpaceWeatherBulletinIWXXMParser<java.lang.String> {
        @Override
