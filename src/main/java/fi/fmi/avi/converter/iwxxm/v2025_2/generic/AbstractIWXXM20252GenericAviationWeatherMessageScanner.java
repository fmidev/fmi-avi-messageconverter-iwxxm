package fi.fmi.avi.converter.iwxxm.v2025_2.generic;
...
public abstract class AbstractIWXXM20252GenericAviationWeatherMessageScanner extends AbstractGenericAviationWeatherMessageScanner {
    ...
    protected static void collectIssueTime(final Element element, final XPath xpath, final GenericAviationWeatherMessageImpl.Builder builder,
        ...
        collectIssueTime(xpath, "./iwxxm2025_2:issueTime/gml:TimeInstant/gml:timePosition", element, builder, issues);
    }
}
