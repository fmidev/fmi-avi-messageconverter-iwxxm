package fi.fmi.avi.converter.iwxxm.v2_1.tca;
...
public class GenericTropicalCycloneAdvisoryIWXXMScanner extends AbstractGenericAviationWeatherMessageScanner {
    ...
    static {
        ...
        locationIndicatorExpressions.put(GenericAviationWeatherMessage.LocationIndicatorType.ISSUING_CENTRE,
                "iwxxm:issuingTropicalCycloneAdvisoryCentre/aixm:Unit/aixm:timeSlice/aixm:UnitTimeSlice");
